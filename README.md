...
```
cd existing_repo
git remote add origin https://gitlab.com/ifba/projetos/vibraventura/vibraventura-front.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ifba/projetos/vibraventura/vibraventura-front/-/settings/integrations)
