                    ...
                    >
                        <div className="relative w-full h-full bg-white">
                            <div className="grid lg:grid-cols-2 h-full">
                                ...
                                {/* Conteúdo */}
                                <div className="p-8 lg:p-12 flex flex-col justify-center space-y-6 relative bg-white">
                                    {/* Decoração de fundo */}
                                    <motion.div
                                    ...
                                    <Link href={`/${currentPost.slug}`}>
                                        <motion.h2
                                            ...
                                            transition={{ delay: 0.3 }}
                                            className="text-3xl lg:text-4xl font-primary font-bold text-secondary leading-tight hover:text-accent transition-colors duration-300 line-clamp-3"
                                        >
                                    ...
                                    <motion.div
                                        ...
                                        className="text-grey text-base lg:text-lg font-primary leading-relaxed line-clamp-4"
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent via-tertiary to-secondary flex items-center justify-center text-white font-bold font-secondary shadow-lg">
                                                {(metadata.autor || "V")[0].toUpperCase()}
                                            </div>
                                            <div>
                                                <p className="text-xs text-grey font-primary">Por</p>
                                                <p className="font-secondary font-bold text-secondary text-sm">
                                                    {metadata.autor || "Vibraventura"}
                                                </p>
                                            </div>
                                        </div>

                                        <div className="w-px h-10 bg-grey/20" />
                                    ...
                                    >
                                        <Link href={`/${currentPost.slug}`}>
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.95 }}
                                                className="relative overflow-hidden bg-gradient-to-r from-accent to-accent-hover text-white font-secondary font-bold uppercase tracking-wider px-6 py-3 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300"
                                            >
